...
<script type="javascript">
  function addItem(){
    <%
      ...
      cardItem.setItemCount(BigDecimal.valueOf(0));
      cardItem.setItemName("");
      cardItem.setItemOwner("");
      pageContext.setAttribute("newCard",cardItem);
    %>
    ${card.items.add(pageContext.getAttribute("newCard"))}
  }
  addItem();
</script>